...
<body>
    <div class="min-h-screen flex flex-col justify-between">
                    ...
                    <div class="w-full md:mt-0 sm:max-w-md xl:p-0 h-full">
                        <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                            ...
                            <form class="space-y-4 md:space-y-6" method="POST" enctype="multipart/form-data">
                                ...
                                <input type="submit" name="submit" id='submit' value='Valider' class="w-full text-white bg-blue-700 hover:bg-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center focus:ring-4 focus:outline-none focus:ring-blue-300" onclick="openload()">
                            </form>
                            <div id='load'></div>
                        </div>
                    </div>
        ...
        <script>
            function openload() {
                document.getElementById('load').innerHTML = `<?php echo addslashes(file_get_contents("../components/chargement.php")); ?>`;
            }
