                ...
                ?>
                    <li class="inline-flex flex-col text-center w-auto p-5">
                        <div class="max-w-sm p-6 bg-blue-100 border rounded-lg ">
                            ...
                            <a href="/components/validation.php?token=<?= $_GET["token"] ?>&id_cours=<?= $cours->getIdCours() ?>&page=<?= $page ?>" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300">
                                <?= $bouton ?>
