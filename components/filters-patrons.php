    ...
    <div id="filterSection" class="hidden block relative md:py-5 lg:px-20 md:px-6 py-4 px-4 w-full">
        ...
        <form action="patrons.php">
            ...
            <div class="block md:hidden w-full mt-5">
                <a href="/patrons.php?token=<?= $_GET["token"] ?>"><button type="button" class="w-full text-base leading-4 font-normal py-3 px-5 bg-gray-100 text-blue-700 border border-2 border-blue-700">Réinitialiser</button></a>
            </div>
        ...
        <div class="hidden md:block absolute right-[135px] bottom-0 md:py-5 py-5">
            <a href="/patrons.php?token=<?= $_GET["token"] ?>"><button type="button" class="h-[48px] w-[110px] border border-2 rounded-md border-blue-600 bg-gray-100 text-blue-700 ">Réinitialiser</button></a>
        </div>
